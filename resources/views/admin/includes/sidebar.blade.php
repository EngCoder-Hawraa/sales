<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background: #09135B">
    <!-- Brand Logo -->
    <a href="index3.html" class="brand-link">
        <img src="{{asset('assets/admin/dist/img/logo.png')}}" alt="logo" class="elevation-3" style="opacity: .8">
